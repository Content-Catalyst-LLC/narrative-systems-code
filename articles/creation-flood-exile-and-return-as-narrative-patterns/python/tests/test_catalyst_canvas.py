...
from catalyst_canvas.scoring import (
    domain_strength,
    risk_score,
...
class CatalystCanvasAdvancedTests(unittest.TestCase):
    def setUp(self) -> None:
        self.config = CanvasConfig(
            article_title="Creation, Flood, Exile, and Return as Narrative Patterns",
            article_slug="creation-flood-exile-and-return-as-narrative-patterns",
